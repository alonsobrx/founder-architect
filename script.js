...
const CONTENT = {
  en: {
    ...
    footer_investment: 'Ayala™ Neurointelligence System — Independent Research Platform — Developed 2014–Present',
  ...
  es: {
    ...
    letter_p1: 'No soy un cabildero. No soy un consultor. Ninguna empresa, corporación de desarrollo económico ni agencia gubernamental me paga. Soy un veterano discapacitado con trece años de servicio en el Ejército de los Estados Unidos como Sargento de Estado Mayor. Soy residente de toda la vida del Valle del Río Grande. Soy el fundador de Brasidas Strategies y el arquitecto principal de Ayala™ — un sistema de neurointeligencia desarrollado durante más de una década para servir a los veteranos, los ciegos, los discapacitados y sus familias.',
    ...
    final_p2: 'Soy un veterano discapacitado con servicio militar y fundador de Brasidas Strategies. El sistema analítico que produjo esta investigación — Ayala™ — fue desarrollado de forma independiente durante más de una década. Brasidas Strategies no tiene ningún interés financiero en el resultado de esta votación, ninguna relación de cliente con ninguna de las partes de esta transacción y ninguna afiliación con ninguna organización de desarrollo económico.',
    ...
    footer_investment: 'Ayala™ Sistema de Neurointeligencia — Plataforma de Investigación Independiente — Desarrollado 2014–Presente',
